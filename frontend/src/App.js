...
function App() {
    ...
    const handleNotionExport = async () => {
        ...
        try {
            await axios.post('http://localhost:8000/export-to-notion', {
    ...
    const handleChatSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:8000/chat', { question: question, transcript: fullTranscript });
